Ứng dụng được phát triển bằng ngôn ngữ Java theo mô hình 3 lớp (Three-tier Architecture), bao gồm DTO – BUS – DAO, kết hợp với tầng giao diện (GUI) xây dựng bằng Java Swing cho ứng dụng desktop.
